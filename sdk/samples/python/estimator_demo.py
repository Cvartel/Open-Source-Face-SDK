...
def detector_fitter_sample(sdk_path: str, image_path: str, mode: str, window: str):
    parsers = {
        "all": parse_all,
    ...
    if mode == "eye_openness" or mode == "all":
        ...
        if mode == "all":
            for value in all_modes:
                ...
                data = estimate(service, value, data)

    if mode != "all":
        data = estimate(service, mode, data)
...
if __name__ == "__main__":
    ...
    detector_fitter_sample(args.sdk_path, args.input_image, args.mode, args.window)

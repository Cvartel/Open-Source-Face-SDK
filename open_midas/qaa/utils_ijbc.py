...
def precalculate_ijbc_features(backbone_bnf, regressor, image_dir, lmk_5pts_path, use_flip_test=False,
    ...
    """Used to precalculate features and quality for IJB-C dataset
    arguments:
    backbone_bnf -- backbone that return embedding and BN features (for example via BNFeatureExtractor)
    regressor -- quality regressor (CatBoost)
    image_dir -- directory with IJB-C images
    lmk_5pts_path -- path to file with landmarks (IJB-C meta)
    """
